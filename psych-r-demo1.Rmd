...
setwd("~/R/teaching materials/psych-demo")
...
`setwd("C/Users/xm42/University/Research methods")`
...
t %>%
  ...
  geom_errorbar(aes(ymin = avg_rating - se_rating, ymax = avg_rating + se_rating), width = .2)
